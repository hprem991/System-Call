...
printint(int fd, int xx, int base, int sgn)
{
 ...
 af8:	0f b6 80 94 11 00 00 	movzbl 0x1194(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 c34:	75 25                	jne    c5b <printf+0xff>
          s = "(null)";
 c36:	c7 45 f4 3f 0f 00 00 	movl   $0xf3f,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 cfc:	a1 b0 11 00 00       	mov    0x11b0,%eax
...
free(void *ap)
{
 ...
 dc7:	a3 b0 11 00 00       	mov    %eax,0x11b0
}
 dcc:	90                   	nop
 dcd:	c9                   	leave  
 dce:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 e25:	83 c4 10             	add    $0x10,%esp
  return freep;
 e28:	a1 b0 11 00 00       	mov    0x11b0,%eax
}
 e2d:	c9                   	leave  
 e2e:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 e41:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 e44:	a1 b0 11 00 00       	mov    0x11b0,%eax
 e49:	89 45 f0             	mov    %eax,-0x10(%ebp)
 e4c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 e50:	75 23                	jne    e75 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 e52:	c7 45 f0 a8 11 00 00 	movl   $0x11a8,-0x10(%ebp)
 e59:	8b 45 f0             	mov    -0x10(%ebp),%eax
 e5c:	a3 b0 11 00 00       	mov    %eax,0x11b0
 e61:	a1 b0 11 00 00       	mov    0x11b0,%eax
 e66:	a3 a8 11 00 00       	mov    %eax,0x11a8
    base.s.size = 0;
 e6b:	c7 05 ac 11 00 00 00 	movl   $0x0,0x11ac
 e72:	00 00 00 
  }
 ...
 ec8:	a3 b0 11 00 00       	mov    %eax,0x11b0
      return (void*)(p + 1);
 ...
 ed3:	eb 3b                	jmp    f10 <malloc+0xe1>
    ...
    if(p == freep)
 ed5:	a1 b0 11 00 00       	mov    0x11b0,%eax
